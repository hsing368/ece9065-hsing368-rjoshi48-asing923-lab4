...
let playlistSchema = new Schema({
    ...
    user_id: { type: mongoose.Schema.Types.ObjectId, ref: 'User' },             // UUID of user created playlist
    songs: [{ type: Schema.Types.ObjectId, ref: 'Song' }],                      // Description of songs in the user created playlist
